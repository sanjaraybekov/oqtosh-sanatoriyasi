    ...
    >
      <Layout>
        <Switch>
          ...
          <Route path="/biz-haqimizda" component={BizHaqimizda}></Route>
          <Route path="/xizmatlar" component={Xizmatlar}></Route>
          <Route path="/bizning-jamoa" component={BizningJamoa}></Route>
          <Route path="/shifokorlar" component={Shifokorlar}></Route>
          <Route path="/tibbiyot" component={Tibbiyot}></Route>
          <Route path="/yotoqxonalar" component={Yotoqxonalar}></Route>
